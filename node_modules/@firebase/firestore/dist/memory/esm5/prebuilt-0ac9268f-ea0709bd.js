 ...
 */ function E(t) {
    ...
    if (b.logLevel <= e.DEBUG) {
        var i = n.map(N);
        b.debug.apply(b, m([ "Firestore (8.2.4): " + t ], i));
    }
}
...
function I(t) {
    ...
    if (b.logLevel <= e.ERROR) {
        var i = n.map(N);
        b.error.apply(b, m([ "Firestore (8.2.4): " + t ], i));
    }
}
...
function T(t) {
    ...
    if (b.logLevel <= e.WARN) {
        var i = n.map(N);
        b.warn.apply(b, m([ "Firestore (8.2.4): " + t ], i));
    }
}
...
//# sourceMappingURL=prebuilt-0ac9268f-ea0709bd.js.map
