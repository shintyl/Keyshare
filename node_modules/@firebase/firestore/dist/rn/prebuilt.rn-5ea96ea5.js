...
class W {
    ...
    getToken() {
        ...
        this.F !== t ? (R("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
...
class Ft extends xt {
    ...
    isEqual(t) {
        return t instanceof Ft && t.hasCommittedMutations === this.hasCommittedMutations && t.version.isEqual(this.version) && t.key.isEqual(this.key);
    }
}
 ...
 */ function _e(t) {
    ...
    if (null === e.Ft) {
        ...
        t.ht() || e.Ft.push(new te(t)), e.Ft.push(new te(tt.lt(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function fe(t) {
    const e = b(t);
    if (!e.Ot) if ("F" /* First */ === e.limitType) e.Ot = Mt(e.path, e.collectionGroup, _e(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.Ot = Mt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.Ot;
}
 ...
 */ function ve(t, e) {
    return t instanceof Fe ? gt(n = e) || function(t) {
...
function Le(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof De && e instanceof De || t instanceof xe && e instanceof xe ? C(t.elements, e.elements, Tt) : t instanceof Fe && e instanceof Fe ? Tt(t.Qt, e.Qt) : t instanceof Se && e instanceof Se;
...
class Nn {
     ...
     */    wn(t) {
        for (const e of t.We) t.je instanceof Nt ? this.En(e, t.je) : t.je instanceof Ft && this.Tn(e, t.key, t.je);
     ...
     */    pn(t) {
        ...
        this.ln.forEach(((n, s) => {
            ...
            if (i) {
                if (n.qe && qt(i.target)) {
                    ...
                    null !== this._n.get(e) || this.bn(s, e) || this.Tn(s, e, new Ft(e, t));
                }
        ...
        return this._n = dn(), this.fn = Fn(), this.dn = new ln(D), s;
    }
    /**
...
function ts(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? F.UNKNOWN : cn(t.code);
 ...
 */ (o);
        ...
        s.document;
        const i = jn(t, s.document), r = s.readTime ? Un(s.readTime) : J.min(), o = new Ft(i, r), c = s.removedTargetIds || [];
        n = new Sn([], c, o.key, o);
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        if ("setToServerValue" in e) p("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
            ...
            n = new xe(t);
        } else "increment" in e ? n = new Fe(t, e.increment) : V();
 ...
 */ class As {
    ...
    next(t, e) {
        return this.Fn && V(), this.Fn = !0, this.Nn ? this.error ? this.On(e, this.error) : this.kn(t, this.result) : new As(((n, s) => {
            this.Cn = e => {
     ...
     */    async Jn(t) {
        return this.db || (R("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new O(F.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
            }, s.onupgradeneeded = t => {
...
class Ds {
     ...
     */    cancel(t) {
        null !== this.As && (this.clearTimeout(), this.Ts.reject(new O(F.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Rs() {
 ...
 */ function Cs(t, e) {
    if (P("AsyncQueue", `${e}: ${t}`), Vs(t)) return new O(F.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */
async function Vi(t) {
    if (t.code !== F.FAILED_PRECONDITION || t.message !== xs) throw t;
...
/** A mutation queue for a specific user, backed by IndexedDB. */ class Di {
    ...
    Mi(t) {
        return Fi(t).get(this.userId).next((t => t || new Bs(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ class ki {
    ...
    ki(t, e) {
        const n = Fs(e.path), s = IDBKeyRange.bound([ n ], [ x(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return $i(t).ls({
...
class Ki {
     ...
     */    Nr(t, e) {
        return function(t, e) {
            let n = !1;
            return Fi(t)._s((s => Ci(t, s, e).next((t => (t && (n = !0), As.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    Vr(t, e) {
        ...
        return this.Cr(t, ((r, o) => {
            if (o <= e) {
                const e = this.Nr(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.fi(t, r).next((() => (n._i(r), $i(t).delete([ 0, Fs(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class ji {
     ...
     */    $r(t) {
        if (t) {
            ...
            return e instanceof Ft && e.version.isEqual(J.min()) ? null : e;
        }
        return null;
    }
}
    ...
    Ei(t) {
        ...
        return this.oi.forEach(((i, r) => {
            ...
            if (r.li) {
                ...
                const n = ci(this.Gr.Kt, new Ft(i, J.min()), this.ai(i));
     ...
     */    Yr(t) {
        ...
        return t.store(Hs.store).get(Hs.key).next((t => {
            ...
            return n.ls(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? As.resolve() : (n => e.put(new zs(0, Fs(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => As.$n(s)));
        }));
    }
    Xr(t, e) {
...
class tr {
    ...
    u) {
        ...
        this.ho = t => Promise.resolve(), !tr.Wn()) throw new O(F.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
     ...
     */    vo(t) {
        ...
        return er(t).get($s.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || nr(t).os().next((t => void 0 === this.Oo(t, 5e3).find((t => {
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Qo() {
        return this.runTransaction("getActiveClients", "readonly", (t => nr(t).os().next((t => this.Oo(t, 18e5).map((t => t.clientId))))));
    }
    get Tr() {
        return this.ro;
    }
    ...
    runTransaction(t, e, n) {
        ...
        "readwrite-primary" === e ? this.po(i).next((t => !!t || this.vo(i))).next((e => {
            ...
            this.eo.bo((() => this.ho(!1))), new O(F.FAILED_PRECONDITION, xs);
            return n(i);
    ...
    Go(t) {
        return er(t).get($s.key).next((t => {
            if (null !== t && this.Fo(t.leaseTimestampMs, 5e3) && !this.Mo(t.ownerId) && !this.Co(t) && !(this.so || this.allowTabSynchronization && t.allowTabSynchronization)) throw new O(F.FAILED_PRECONDITION, Zi);
        }));
    }
    /**
...
class ar {
    ...
    t, e, n, s) {
         ...
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Ec = J.min(), this.Ho = t.Ko(n), this.Tc = t.Or(), this.fo = t.Dr(), this.Ic = new rr(this.Tc, this.Ho, this.persistence.Wo()), 
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o instanceof Ft && o.version.isEqual(J.min()) ? (
 ...
 */ class Dr {
    constructor(t) {
         ...
         * IDs.
         */
        this.Jc = new Vr, this.targetCount = 0, this.Yc = Oi.$i();
    }
    mn(t, e) {
...
class Mr {
     ...
     */    static aa(t, e, n) {
        ...
        i && (r = new O(s.error.code, s.error.message))), i ? new Mr(t, e, s.state, r) : (P("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    ua() {
        const t = {
...
class Lr {
     ...
     */    static aa(t, e) {
        ...
        s && (i = new O(n.error.code, n.error.message))), s ? new Lr(t, n.state, i) : (P("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    ua() {
        const t = {
 ...
 */ class Ur {
    constructor(t, e, n, s, i) {
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ma = Fr(this.persistenceKey, this._a), 
        this.Aa = 
...
class {
    ...
    xu(t, e) {
        ...
        // enough the code is exception free.
            ...
            A || (A = !0, y("Connection", "WebChannel transport errored:", t), P.Pu(new O(F.UNAVAILABLE, "The operation could not be completed")));
...
class no extends class {} {
    ...
    mh() {
        if (this.Ih) throw new O(F.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    bu(t, e, n) {
        return this.mh(), this.credentials.getToken().then((s => this.Ku.bu(t, e, n, s))).catch((t => {
            throw t.code === F.UNAUTHENTICATED && this.credentials.v(), t;
        }));
    }
        ...
        this.Oh = [], this.kh = i, this.kh.cu((t => {
            n.ys((async () => {
                ...
                await async function(t) {
                    const e = b(t);
                    e.Fh.add(4 /* ConnectivityChange */), await oo(e), e.Mh.set("Unknown" /* Unknown */), 
                    e.Fh.delete(4 /* ConnectivityChange */), await ro(e);
                }(this));
            }));
        })), this.Mh = new so(n, s);
    }
...
async function ro(t) {
    if (fo(t)) for (const e of t.Oh) await e(/* enabled= */ !0);
}
 ...
 */ async function mo(t, e, n) {
    ...
    t.fs.bo((async () => {
        R("RemoteStore", "Retrying IndexedDB access"), await n(), t.Fh.delete(1 /* IndexedDbFailed */), 
        await ro(t);
    }));
}
...
async function Do(t, e) {
    const n = b(t);
    e ? (n.Fh.delete(2 /* IsSecondary */), await ro(n)) : e || (n.Fh.add(2 /* IsSecondary */), 
 ...
 */ class Bo {
    ...
    nl(t) {
        t = pn.Fe(t.query, t.docs, t.Ce, t.fromCache), this.Xh = !0, this.Yh.next(t);
    }
}
 ...
 */ class Uo {
     ...
     */    gc(t) {
        return t.metadata.exists ? Xn(this.Kt, t.document, !1) : new Ft(this.yc(t.metadata.name), this.Vc(t.metadata.readTime));
    }
    Vc(t) {
        return Un(t);
    }
 ...
 */ (t.type, e.type) || this.ll(t.doc, e.doc))), this.Tl(n);
    ...
    // PORTING NOTE: Multi-tab only.
    Pl() {
        return pn.Fe(this.query, this._l, this.Ce, 0 /* Local */ === this.ul);
    }
}
 ...
 */ class Jo {
    ...
    s, i, r) {
         ...
         */
        this.Nl = new Map, this.Fl = new Vr, 
...
async function ic(t, e) {
    ...
    try {
        ...
        // before listen events.
                ac(n, s, /*error=*/ null), cc(n, s), n.pl.Fa(s, "acknowledged"), await dc(n, t);
    } catch (t) {
        await Vi(t);
    }
}
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.Ho.yi(t, e).next((e => (p(null !== e), s = e.keys(), n.Ho.xi(t, e)))).next((() => n.Ho.Oi(t))).next((() => n.Ic.Zo(t, s)));
            }));
        }
        /**
 ...
 */ (s.Sh, e);
        ...
        // listen events.
                ac(s, e, n), cc(s, e), s.pl.Fa(e, "rejected", n), await dc(s, t);
    } catch (n) {
        await Vi(n);
    }
}
...
function lc(t, e, n) {
    for (const s of n) if (s instanceof Wo) t.Fl.sr(s.key, e), _c(t, s); else if (s instanceof jo) {
        R("SyncEngine", "Document no longer in limbo: " + s.key), t.Fl.rr(s.key, e);
        t.Fl.ki(s.key) || 
        // We removed the last reference for this key
        hc(t, s.key);
    } else V();
...
async function Ac(t, e) {
    ...
    if (pc(n), bc(n), !0 === e && !0 !== n.Ll) {
        ...
        function(t) {
            ...
            e.Nl.forEach(((t, n) => {
                ao(e.gl, n);
            })), e.Fl.Mc(), e.Nl = new Map, e.xl = new an(et.J);
        }
        /**
 ...
 */ class Cc extends Dc {
    ...
    jl(t) {
        const e = Hr();
        if (!Ur.Wn(e)) throw new O(F.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class xc {
    ...
    terminate() {
        return async function(t) {
            const e = b(t);
            R("RemoteStore", "RemoteStore shutting down."), e.Fh.add(5 /* Shutdown */), await oo(e), 
            e.kh.Lo(), 
 ...
 */ function qc(t) {
    if (!et.Et(t)) throw new O(F.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Uc(t) {
    if (et.Et(t)) throw new O(F.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Zc(t, e) {
    if (t = Kc(t, zc), Lc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O(F.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Jc(t, 
    /* converter= */ null, 
    /**
...
class Ta extends Mc {
    ...
    z_(t) {
        const e = new Fe(t.Kt, ge(t.Kt, this.J_));
 ...
 */ class Da {
    ...
    async ef(t) {
        ...
        return e.forEach((t => {
            t instanceof Ft || t instanceof Nt ? this.sf(t) : V();
        })), e;
    }
    set(t, e) {
...
class xa {
     ...
     */    df() {
        if (this.fs.wf) throw new O(F.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
        this.fs.Ef();
        const t = new ms;
...
async function Fa(t, e) {
    ...
    t.ff((n => t.fs.bo((() => async function(t, e) {
        ...
        // new mutations from the LocalStore (since mutations are per-user).
                n.Fh.add(3 /* CredentialChange */), await oo(n), s && 
...
async function ka(t) {
    return t.If || (R("FirestoreClient", "Using default OnlineComponentProvider"), await Fa(t, new xc)), 
    t.If;
}
...
/** Enables the network connection and re-enqueues all pending operations. */ function Ua(t) {
    return t.fs.enqueue((async () => {
        ...
        return e.Vo(!0), function(t) {
            const e = b(t);
            return e.Fh.delete(0 /* UserDisabled */), ro(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function Qa(t) {
    return t.fs.enqueue((async () => {
        ...
        return e.Vo(!1), async function(t) {
            const e = b(t);
            e.Fh.add(0 /* UserDisabled */), await oo(e), 
 ...
 */ function Ka(t, e) {
    ...
    return t.fs.ys((async () => async function(t, e, n) {
        try {
            ...
            s instanceof Nt ? n.resolve(s) : s instanceof Ft ? n.resolve(null) : n.reject(new O(F.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
    ...
    return t.fs.ys((async () => function(t, e, n, s, i) {
        const r = new Fc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.ys((() => ko(t, o))), n.fromCache && "server" === s.source ? i.reject(new O(F.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Bo(n, r, {
            includeMetadataChanges: !0,
 ...
 * limitations under the License.
 */ function lu(t) {
    if (ae(t) && 0 === t.Nt.length) throw new O(F.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function mu(t, e, n, s) {
    if (n[0] instanceof M && (n[0] = n[0]._), n[0] instanceof au) return function(t, e, n, s, i) {
        ...
        // results.
            ...
            if (ht(t)) throw new O(F.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.ot();
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.ht()) {
                    ...
                    if (!le(t) && -1 !== a.indexOf("/")) throw new O(F.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(X.ct(a));
                    if (!et.Et(n)) throw new O(F.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new et(n);
                    c.push(yt(e, i));
                } else {
                    const t = Aa(n, s, a);
...
function Au(t, e, n) {
    if (n instanceof M && (n = n._), "string" == typeof n) {
        ...
        if (!le(e) && -1 !== n.indexOf("/")) throw new O(F.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(X.ct(n));
        if (!et.Et(s)) throw new O(F.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return yt(t, new et(s));
    }
    if (n instanceof Hc) return yt(t, n.S_);
    throw new O(F.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Qc(n) + ".");
}
 ...
 */ class Su {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.ud.Ne) throw new O(F.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */ function Nu(t, e, n, ...s) {
    ...
    return Ou(i, [ o.F_(t.S_, Be.exists(!0)) ]);
}
 ...
 */ function Fu(t, ...e) {
    ...
    return function(t, e, n, s) {
        const i = new Fc(s), r = new Bo(e, i, n);
        return t.fs.ys((async () => Oo(await qa(t), r))), () => {
 ...
 */ class Mu {
    ...
    set(t, e, n) {
        ...
        return this.fd.push(r.F_(s.S_, Be.Wt())), this;
    }
    update(t, e, n, ...s) {
        this.Ed();
        ...
        this.fd.push(r.F_(i.S_, Be.exists(!0))), this;
    }
    /**
...
class $u extends class {
     ...
     */    get(t) {
        ...
        return this.Td.ef([ e.S_ ]).then((t => {
            ...
            const s = t[0];
            if (s instanceof Ft) return new au(this.zf, n, e.S_, null, e.v_);
...
class Hu extends M {
    ...
    static yd(t, e, n) {
        if (t.length % 2 != 0) throw new O(F.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t.ot()} has ${t.length}`);
    ...
    set(t, e) {
        ...
        try {
            return function(t, e, n) {
                ...
                return Ou(s, [ la(ha(s), "setDoc", t.S_, i, null !== t.v_, n).F_(t.S_, Be.Wt()) ]);
            }(this._, t, e);
        } catch (t) {
    ...
    delete() {
        return Ou(Kc((t = this._).firestore, tu), [ new tn(t.S_, Be.Wt()) ]);
        var t;
        /**
...
class ih extends eh {
    ...
    add(t) {
        return function(t, e) {
            ...
            return Ou(n, [ la(ha(t.firestore), "addDoc", s.S_, i, null !== t.v_, {}).F_(s.S_, Be.exists(!1)) ]).then((() => s));
...
//# sourceMappingURL=prebuilt.rn-5ea96ea5.js.map
